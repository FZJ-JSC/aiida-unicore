"""
Calculations provided by aiida_unicore.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'unicore'
        ...
        spec.output('unicore', valid_type=SinglefileData, help='diff between file1 and file2.')
