...
class UnicoreJobResource(NodeNumberJobResource):
...
class UnicoreScheduler(Scheduler):
    """
    Support for the Unicore scheduler (https://www.unicore.eu/).
    """
    _logger = Scheduler._logger.getChild('unicore')
